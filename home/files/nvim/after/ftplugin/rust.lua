...
map('<leader>rf', function() vim.cmd.RustLsp({ 'flyCheck', 'run' }) end, 'Rust fly check run')
map('<leader>rF', function() vim.cmd.RustLsp({ 'flyCheck', 'clear' }) end, 'Rust fly check clear')
