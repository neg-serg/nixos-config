...
|--------|-----|---------|----------|--------|--------|-----------|
| **Baseline** | cold | 4.78 | 5.13 | 11,175,376 | 7,072,131 | 327.0 |
| Wave 1 | cold #1 | 4.704 | 5.39 | 11,197,771 | 7,066,783 | 326.7 |
| Wave 1 | cold #2 | 4.579 | 5.01 | 11,197,771 | 7,066,783 | 326.7 |
| Wave 1 | warm avg | 4.854 / 4.776 | 5.74 / 5.65 | 11,197,735 | 7,066,750 | 326.7 |

## Comparison (Avg Cold vs Baseline)

| Metric | Baseline | Wave 1 Avg | Delta | % Change |
|--------|----------|------------|-------|----------|
| **CPU (s)** | 4.780 | 4.642 | **-0.138** | **−2.89%** ✅ |
| **Wall (s)** | 5.13 | 5.20 | +0.07 | +1.36% (noise) |
| **Values** | 11,175,376 | 11,197,771 | +22,395 | +0.20% |
| **Thunks** | 7,072,131 | 7,066,783 | **−5,348** | **−0.08%** ✅ |
...
### Noise / Neutral
- **Wall time**: first run +5.07%, second run −2.34%. Averaged to +1.36%, confirming this is within run-to-run noise (system load, disk cache). No regression confirmed.
- **Values**: +22,395 (+0.20%) — marginal increase, possibly from new disabledModules entries requiring some module structure to remain.
...
|--------|--------------|
| **Shadow dedup** | Thunk reduction (fewer copies of pkgs to evaluate), CPU improvement |
| **disabledModules** | Slightly more values if modules import dependencies that weren't previously evaluated; otherwise neutral or mildly beneficial |

## Verdict

**Wave 1 is performance-neutral to slightly positive.** CPU improved ~3%, thunks and sets marginally reduced, no regression confirmed. The shadow dedup change is the primary driver of the thunk/set reduction.
