...
- Metrics: CPU time, wall time, values, thunks, sets_bytes, GC time, GC fraction, nrAvoided,
  nrLookups
...
| ID | Component | Outcome | Status | |----|-----------|---------|--------| | C1 | Upstream nixpkgs
baseline measurement | CPU/mem stats for NixOS/nixpkgs | pending | | C2 | Fork (nixpkgs-slim)
measurement | CPU/mem stats for neg-serg/nixpkgs-slim | pending | | C3 | Comparison table |
Side-by-side deltas in terminal + MD | pending | | C4 | Validation | Measurements consistent, no
confounding factors | pending |
