...
| ID | Component | Wave | Status | |----|-----------|------|--------| | C1 | B: Shadow ×55 fix | 1 |
pending | | C2 | D: Additional disabledModules | 1 | pending | | C3 | A: Fork cleanup (web-apps +
cascade) | 2 | pending | | C4 | C: Domain filter tighten | 3 | pending | | C5 | E: hostExtras
pathExists fix | 3 | pending | | C6 | Final benchmark + cumulative report | 4 | pending |
