...
1. shana OnceLock кеширует сломанное D-Bus соединение
1. Нет таймаута на shana proxy .await → вечное зависание
1. Hyprland portal не имплементирует FileChooser (by design)
