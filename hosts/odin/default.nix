{ pkgs, lib, config, ... }:
{
  ...
  features.virt.libvirtd.enable = true; # KVM/QEMU (ISOEnts.zip URL fixed in fix-opencode overlay)
  features.apps.winapps.enable = true; # Windows apps as native windows
