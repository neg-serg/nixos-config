...
| Файл | Назначение | |------|------------| | `default.nix` | Основной конфиг и пути моделей | |
`ollama.nix` | Сервис Ollama (ROCm) | | `open-webui.nix` | Веб-интерфейс | | `codex-config.nix` |
Конфиг ассистента Codex | | `pkgs.nix` | CLI утилиты |
...
| Сервис | Порт | Описание | |--------|------|----------| | Ollama | 11434 | API endpoint |
