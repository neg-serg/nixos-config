...
| `images/` | Image viewers and editors |
...
PipeWire with low-latency configuration for gaming and music production.
...
- `modules/user/nix-maid/apps/mpv/` — mpv player config
