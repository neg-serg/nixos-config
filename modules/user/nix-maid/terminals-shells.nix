{pkgs, ...}: let
  # Source Paths
  kittyConf = ../../../home/modules/user/gui/kitty/conf;
  weztermConf = ../../../home/modules/user/gui/wezterm/conf;
  nuConfDir = ../../../home/modules/cli/nushell-conf;
  tmuxConfDir = ../../../home/modules/cli/tmux-conf;
...
in {
  ...
  users.users.neg.maid.file.home = {
    ...
    # Nushell Config
    ".config/nushell/aliases.nu".source = "${nuConfDir}/aliases.nu";
    ".config/nushell/git.nu".source = "${nuConfDir}/git.nu";
    ".config/nushell/broot.nu".source = "${nuConfDir}/broot.nu";
    ".config/nushell/git-completion.nu".source = "${nuConfDir}/git-completion.nu";
    ...
    ".config/nushell/config.nu".source = "${nuConfDir}/config.nu";
    ...
    # Zsh config with oh-my-posh
    ".zshrc".text = ''
      # -- Generated by NixOS (nix-maid) --
      ...
      # Basic options
      setopt AUTO_CD INTERACTIVE_COMMENTS CORRECT
      unsetopt BEEP
      ...
      # Oh-My-Posh prompt
      eval "$(${pkgs.oh-my-posh}/bin/oh-my-posh init zsh --config ${ompConfig})"
