  ...
  config = lib.mkMerge [
    {
      ...
      environment.variables = {
        ...
        FZF_DEFAULT_OPTS = neg.guardFzfOpts "FZF_DEFAULT_OPTS" (
          builtins.concatStringsSep " " (
            builtins.filter (x: builtins.typeOf x == "string") [
              ...
              # NB: fzf stops parsing FZF_DEFAULT_OPTS at '#' — keep inline '#' out of the string
              "--bind='ctrl-n:down,ctrl-p:up,ctrl-f:page-down,ctrl-b:page-up,ctrl-a:beginning-of-line,ctrl-e:end-of-line'"
        ...
        FZF_CTRL_R_OPTS = neg.guardFzfOpts "FZF_CTRL_R_OPTS" (
          builtins.concatStringsSep " " [
            "--sort"
            "--exact"
        ...
        FZF_CTRL_T_OPTS = neg.guardFzfOpts "FZF_CTRL_T_OPTS" (
          builtins.concatStringsSep " " [
