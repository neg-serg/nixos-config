...
hyprlandConfig = pkgs.writeText "greetd-hyprland-config.lua" ''
  ...
  hl.on("hyprland.start", function()
    hl.exec_cmd("HOME=/home/greeter QML2_IMPORT_PATH=/etc/greetd/quickshell ${lib.getExe inputs.quickshell.packages.${pkgs.stdenv.hostPlatform.system}.default} -p /etc/greetd/quickshell/greeter/greeter.qml > /tmp/qs-greeter.log 2>&1 && pkill Hyprland")
  end)
'';
