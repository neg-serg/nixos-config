...
EXCLUDE_PATTERN='(with pkgs|inherit|pkgs\.lib|pkgs\.stdenv|pkgs\.system|pkgs\.config|pkgs\.callPackage|pkgs\.write|pkgs\.fetch|pkgs\.python|pkgs\.build|pkgs\.runCommand|pkgs\.symlinkJoin|pkgs\.replaceVars|pkgs\.override|pkgs\.neg\s*=|pkgs\.recurseIntoAttrs|pkgs\.linuxPackages)'
