...
| dsh-memory-extractor          | session-end extract в memento: draft-транскрипт + LLM-шаг через локальный Ollama (JSON по memory-extract.ru.md)         | ✅ draft + LLM `[extract]` (qwen3:8b-q8_0, бенч 5 моделей) + fallback          | 9145ff98, a20260e9, 699c47c0, 39614204 |
