...
| ------------------------------------- | ---------------------------------------------------------------- | ------------------------------------ |
| `git forest [--all --style=10 --sha]` | Console commit tree with branch lines.                           | \`git forest --all --style=10 --sha  |
...
| \`qtar [-x] \[--ext                              | --svn\] <archive> \<paths...>\`                         | Create tar archives with sorted input; `-x` drops .git/.svn/etc.                          |
| \`qplay [-i part] [-q part] [-r rate] [files...] | aplay -f dat -c 1\`                                     | Convert QBASIC PLAY strings to PCM and stream into `aplay`; mixes square+sine by default. |
