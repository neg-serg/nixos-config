...
> Собрано субагентом 2026-08-20 (официальные источники, GitHub API). yabridge (nixpkgs) — только
> 64-бит; 32-бит-плагины исключены. Плагины с нативными Linux-сборками отмечены — их мостить НЕ
> нужно.
...
Rough Rider 3 — все имеют Linux-версии, ставятся пакетами (Vital/Surge/Dexed/OB-Xd уже есть в
nixpkgs).

## MS-20-клоны

Бесплатного MS-20-клона с официальным источником не нашлось. Ближайшие проверенные эмуляции: K1v
(M1), TAL-U-NO-LX (Juno-106), OB-Xd (Oberheim), Dexed (DX7).

## Ссылки

Все ссылки — в таблице выше (проверены субагентом 2026-08-20). Пологские (Plogue) и Xfer страницы
блокируют ботов (403/Cloudflare) — скачивать в браузере.
