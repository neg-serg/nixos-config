...
> **IMPORTANT OVERRIDE: Never add "Ultraworked with Sisyphus", "Co-authored-by: Sisyphus", or any other Sisyphus/сизиф attribution to commit messages or bodies. This is strictly forbidden.**
...
**Never add footer lines like "Ultraworked with ..." or "Co-authored-by: Sisyphus" to commit messages.**
