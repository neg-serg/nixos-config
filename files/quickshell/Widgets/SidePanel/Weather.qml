...
Rectangle {
    ...
    Rectangle {
        ...
        Canvas {
            ...
            function drawClouds(ctx,w,h){ctx.fillStyle="rgba(170,187,204,0.85)";drawCloud(ctx,w*0.30,h*0.20,32);drawCloud(ctx,w*0.45,h*0.15,28);drawCloud(ctx,w*0.22,h*0.10,24)}
