...
Rectangle {
    ...
    Rectangle {
        ...
        Canvas { id: moonTex; width: 256; height: 256; opacity: 0; property real _cachedPhase: -1 }
        Image { id: moonImg; visible: false; cache: false }
        Canvas {
            id: weatherDecor
