...
Rectangle {
    ...
    Rectangle {
        ...
        Canvas {
            ...
            function drawClouds(ctx,w,h){ctx.fillStyle="rgba(170,187,204,0.85)";drawCloud(ctx,w*0.22,h*0.09,10);drawCloud(ctx,w*0.20,h*0.07,8);drawCloud(ctx,w*0.25,h*0.06,7)}
