...
local PARAM_RE =
	[[\v<(sound|note|n|s|gain|pan|room|size|delay|delaytime|delayfeedback|lpf|hpf|bandf|crush|shape|speed|sustain|release|attack|cutoff|orbit|amp|legato|vowel|slide|accelerate|begin|end|stut|echo|jux|rev|fast|slow|every|sometimes|struct|iter|palindrome|scramble)>]]
local OP_RE = [=[\v[\$#]]=]
