...
swayimg.viewer.on_key("Ctrl-Shift-comma", function()
  local img = swayimg.viewer.current_image()
  exec(actions .. " rotate-ccw " .. cp(img['path']))
end)
swayimg.viewer.on_key("Ctrl-Shift-less", function()
  local img = swayimg.viewer.current_image()
  exec(actions .. " rotate-ccw " .. cp(img['path']))
end)
swayimg.viewer.on_key("Ctrl-Shift-greater", function()
  local img = swayimg.viewer.current_image()
...
key2({"Ctrl-б"}, function() local i=swayimg.viewer.current_image() exec(actions.." rotate-left "..cp(i['path'])) end)
key2({"Ctrl-Shift-б"}, function() local i=swayimg.viewer.current_image() exec(actions.." rotate-ccw "..cp(i['path'])) end)
key2({"Ctrl-ю"}, function() local i=swayimg.viewer.current_image() exec(actions.." rotate-right "..cp(i['path'])) end)
key2({"Ctrl-."}, function() local i=swayimg.viewer.current_image() exec(actions.." rotate-180 "..cp(i['path'])) end)
...
key2({"Shift-с"}, function() local i=swayimg.viewer.current_image() exec(actions.." range-cp "..cp(i['path'])) end)
key2({"Shift-в"}, function() local i=swayimg.viewer.current_image() exec(actions.." range-trash "..cp(i['path'])) end)
key2({"Shift-ь"}, function() local i=swayimg.viewer.current_image() exec(actions.." range-mark "..cp(i['path'])) end)
key2({"Shift-к"}, function() local i=swayimg.viewer.current_image() exec(actions.." range-clear "..cp(i['path'])) end)
key2({"Shift-м"}, function() local i=swayimg.viewer.current_image() exec(actions.." range-mv "..cp(i['path'])) end)
...
swayimg.gallery.on_key("Shift-v", function()
  local img = swayimg.gallery.current_image()
  exec(actions .. " range-mv " .. cp(img['path']))
end)
...
swayimg.gallery.on_key("Ctrl-Shift-comma", function()
  local img = swayimg.gallery.current_image()
  exec(actions .. " rotate-ccw " .. cp(img['path']))
end)
swayimg.gallery.on_key("Ctrl-Shift-less", function()
  local img = swayimg.gallery.current_image()
  exec(actions .. " rotate-ccw " .. cp(img['path']))
end)
swayimg.gallery.on_key("Ctrl-Shift-greater", function()
  local img = swayimg.gallery.current_image()
  exec(actions .. " rotate-right " .. cp(img['path']))
end)
...
key2g({"Ctrl-б"}, function() local i=swayimg.gallery.current_image() exec(actions.." rotate-left "..cp(i['path'])) end)
key2g({"Ctrl-Shift-б"}, function() local i=swayimg.gallery.current_image() exec(actions.." rotate-ccw "..cp(i['path'])) end)
key2g({"Ctrl-ю"}, function() local i=swayimg.gallery.current_image() exec(actions.." rotate-right "..cp(i['path'])) end)
key2g({"Ctrl-."}, function() local i=swayimg.gallery.current_image() exec(actions.." rotate-180 "..cp(i['path'])) end)
...
key2g({"Shift-с"}, function() local i=swayimg.gallery.current_image() exec(actions.." range-cp "..cp(i['path'])) end)
key2g({"Shift-в"}, function() local i=swayimg.gallery.current_image() exec(actions.." range-trash "..cp(i['path'])) end)
key2g({"Shift-ь"}, function() local i=swayimg.gallery.current_image() exec(actions.." range-mark "..cp(i['path'])) end)
key2g({"Shift-к"}, function() local i=swayimg.gallery.current_image() exec(actions.." range-clear "..cp(i['path'])) end)
key2g({"Shift-м"}, function() local i=swayimg.gallery.current_image() exec(actions.." range-mv "..cp(i['path'])) end)
...
swayimg.slideshow.on_key("Shift-c", function()
  local img = swayimg.slideshow.current_image()
  exec(actions .. " range-cp " .. cp(img['path']))
end)
...
key2s({"Shift-с"}, function() local i=swayimg.slideshow.current_image() exec(actions.." range-cp "..cp(i['path'])) end)
key2s({"Shift-в"}, function() local i=swayimg.slideshow.current_image() exec(actions.." range-trash "..cp(i['path'])) end)
key2s({"Shift-ь"}, function() local i=swayimg.slideshow.current_image() exec(actions.." range-mark "..cp(i['path'])) end)
key2s({"Shift-к"}, function() local i=swayimg.slideshow.current_image() exec(actions.." range-clear "..cp(i['path'])) end)
key2s({"Shift-м"}, function() local i=swayimg.slideshow.current_image() exec(actions.." range-mv "..cp(i['path'])) end)
