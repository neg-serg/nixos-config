...
swayimg.viewer.on_key("c", function()
  ...
  exec(actions .. " copy_info " .. cp(img['path']))
end)
...
key2({"с","ы"}, function() local i=swayimg.viewer.current_image() exec(actions.." copy_info "..cp(i['path'])) end)
...
key2g({"с","ы"}, function() local i=swayimg.gallery.current_image() exec(actions.." copy_info "..cp(i['path'])) end)
...
key2s({"с","ы"}, function() local i=swayimg.slideshow.current_image() exec(actions.." copy_info "..cp(i['path'])) end)
