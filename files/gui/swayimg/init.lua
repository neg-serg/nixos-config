...
swayimg.viewer.on_key("backslash", function() swayimg.text.show() end)
...
key2({"О"}, function() local x,y=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(x,y+50) end)
