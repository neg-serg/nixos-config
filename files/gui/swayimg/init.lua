...
key2({"р"}, function() local p=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(p.x-50,p.y) end)
key2({"о"}, function() local p=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(p.x+50,p.y) end)
key2({"л"}, function() local p=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(p.x,p.y-50) end)
key2({"д"}, function() local p=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(p.x,p.y+50) end)
key2({"О"}, function() local p=swayimg.viewer.get_position() swayimg.viewer.set_abs_position(p.x,p.y+50) end)
