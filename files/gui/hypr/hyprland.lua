...
-- ---------------------------------------------------------------------
local m = {
  browser            = "^(org\\.mozilla\\.firefox|firefox|floorp|one\\.ablaze\\.floorp|floorpdeveloperedition)$",
...
local cls = {
  term        = "^(term)$",
  web         = "^(firefox|org\\.mozilla\\.firefox|librewolf|io\\.gitlab\\.librewolf-community|floorp|one\\.ablaze\\.floorp|floorpdeveloperedition|chromium|org\\.chromium\\.Chromium|thorium-browser|com\\.thorium\\.Thorium|palemoon|net\\.palemoon\\.PaleMoon)$",
  dev         = "^(nwim)$",
  games       = "^(steam|Steam)$",
...
hl.bind(M4 .. "+" .. SH .. "+c", hl.dsp.exec_cmd("~/.local/bin/wl"))
...
hl.define_submap("wallpaper", "reset", function()
  submap_resets()
  hl.bind("y", hl.dsp.exec_cmd("~/.local/bin/wl"))
  hl.bind(M4 .. "+y", hl.dsp.exec_cmd("~/.local/bin/wl"))
