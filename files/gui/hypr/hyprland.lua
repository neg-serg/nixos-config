...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.layers.namespaces\"] = \"qs-panel,qs-content-left,qs-content-right,quickshell-bar-reserve,quickshell,notifications,quickshell-music\" })'")
