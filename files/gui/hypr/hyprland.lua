...
-- --- Media (media.conf) ---
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("genlc-media up"), { repeating = true })
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("genlc-media down"), { repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("genlc-media mute"), { repeating = true })
