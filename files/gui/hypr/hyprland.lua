...
-- NOTE: hyprglass was dropped for the nixos-unstable (Hyprland 0.56)
-- migration — 0.56 changed the view internals (m_realPosition/m_realSize
-- are protected, m_alpha is a private CMultiAVarContainer, geometric enum
-- renamed), so its 0.55 postPatch no longer compiles. Re-port all three
...
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("genlc-media mute; swayosd-client --output-volume mute-toggle"), { repeating = true, locked = true })
