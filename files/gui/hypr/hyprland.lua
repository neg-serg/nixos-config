...
-- --- Media (media.conf) ---
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("genlc-media up; swayosd-client --output-volume +5"), { repeating = true })
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("genlc-media down; swayosd-client --output-volume -5"), { repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("genlc-media mute; swayosd-client --output-volume mute-toggle"), { repeating = true })
