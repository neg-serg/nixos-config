...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.refraction_strength\"] = 2 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.chromatic_aberration\"] = 0.8 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.fresnel_strength\"] = 0.5 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.specular_strength\"] = 0.4 })'")
  ...
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.lens_distortion\"] = 0.2 })'")
