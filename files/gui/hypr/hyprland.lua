...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:layers:namespaces 'qs-panel,qs-content-left,qs-content-right,quickshell-bar-reserve,quickshell,shell:background,shell:bar,shell:launcher,shell:notifications,shell:screenshot'")
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:blur_strength 1")
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:blur_iterations 5")
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:refraction_strength 8")
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:chromatic_aberration 0.8")
  ...
  hl.exec_cmd("hyprctl keyword plugin:hyprglass:lens_distortion 0.95")
