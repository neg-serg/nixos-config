...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.layers.namespaces\"] = \"qs-panel,qs-content-left,qs-content-right,quickshell-bar-reserve,quickshell,shell:background,shell:bar,shell:launcher,shell:notifications,shell:screenshot\" })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.blur_strength\"] = 1 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.blur_iterations\"] = 5 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.refraction_strength\"] = 8 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.chromatic_aberration\"] = 0.8 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.fresnel_strength\"] = 2 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.specular_strength\"] = 1.5 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.glass_opacity\"] = 0.85 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.edge_thickness\"] = 0.15 })'")
  hl.exec_cmd("hyprctl eval 'hl.config({ [\"plugin.hyprglass.lens_distortion\"] = 0.95 })'")
