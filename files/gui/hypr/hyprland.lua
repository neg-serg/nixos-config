...
-- ---------------------------------------------------------------------
local m = {
  browser            = "^(org\\.mozilla\\.firefox|firefox|floorp|one\\.ablaze\\.floorp|floorpdeveloperedition|zen-beta)$",
...
local cls = {
  term        = "^(term)$",
  web         = "^(firefox|org\\.mozilla\\.firefox|librewolf|io\\.gitlab\\.librewolf-community|floorp|one\\.ablaze\\.floorp|floorpdeveloperedition|zen-beta|chromium|org\\.chromium\\.Chromium|thorium-browser|com\\.thorium\\.Thorium|palemoon|net\\.palemoon\\.PaleMoon)$",
  dev         = "^(nwim)$",
  games       = "^(steam|Steam)$",
